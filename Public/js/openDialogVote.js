...
function openVoteDialog(el) {
    ...
    // Gọi Fetch
    const url = '/LapTrinhWeb/baitaplon/Vote/dialog/' + encodeURIComponent(partnerId);
...
function submitVote() {
    ...
    fetch('/LapTrinhWeb/baitaplon/Vote/submit', {
        method: 'POST',
        body: formData
    })
...
function showReportSuggestion(targetId) {
    ...
    if (choice) {
        ...
        window.location.href = '/LapTrinhWeb/baitaplon/Report/create?target_id=' + targetId;
    }
}
