    ...
    public function process() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($action === 'BAN_USER') {
                ...
                echo "<script>alert('Đã khóa tài khoản US$reported_id thành công!'); window.location.href='/LapTrinhWeb/baitaplon/AdminReport';</script>";

            } elseif ($action === 'IGNORE') {
                // Từ chối báo cáo
                $this->reportModel->updateStatus($report_id, 'REJECTED', 'Báo cáo không đủ căn cứ.');
                echo "<script>alert('Đã hủy bỏ báo cáo.'); window.location.href='/LapTrinhWeb/baitaplon/AdminReport';</script>";
            }
        }
    }
}
