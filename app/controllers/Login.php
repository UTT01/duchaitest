        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($username) || empty($password)) {
                ...
                if ($user) {
                    ...
                    // 2. Redirect về Home (Giữ nguyên id_user trên URL để code cũ vẫn chạy)
                    $id_user = $user['id_user'];
                    header("Location: /LapTrinhWeb/baitaplon/Home?id_user=" . urlencode($id_user));
                    exit();
                } else {
            ...
            header("Location: /LapTrinhWeb/baitaplon/Login");
            exit();
        }
