...
public function submit() {
        ...
        if ($this->reportModel->checkPendingReport($reporter_id, $target_id)) {
            echo "<script>
                ...
                window.location.href = '/LapTrinhWeb/baitaplon/Chat'; 
            </script>";
            return; 
        }
        ...
        if ($result) {
            ...
            echo "<script>alert('Đã gửi báo cáo thành công! Admin sẽ xem xét.'); window.location.href='/LapTrinhWeb/baitaplon/Chat';</script>";
        } else {
