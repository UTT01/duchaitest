...
<head>
    ...
    <link rel="stylesheet" href="/LapTrinhWeb/baitaplon/public/css/AdminReport.css">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($r['evidence_image'])): ?>
                                            <a href="/LapTrinhWeb/baitaplon/<?= $r['evidence_image'] ?>" target="_blank" class="evidence-link">
                                                <img src="/LapTrinhWeb/baitaplon/<?= $r['evidence_image'] ?>" alt="Evidence">
                                    ...
                                    <td class="text-right">
                                        <?php if ($r['status'] == 'PENDING'): ?>
                                            <form method="POST" action="/LapTrinhWeb/baitaplon/AdminReport/process" class="action-buttons">
...
<script src="/LapTrinhWeb/baitaplon/public/js/exportExcel.js"></script>
