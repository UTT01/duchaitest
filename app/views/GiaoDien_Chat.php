...
<head>
    ...
    <title>Chat Realtime</title>
        <link rel="stylesheet" href="/LapTrinhWeb/baitaplon/public/css/GiaoDien_Chat.css">
</head>
<body>
...
<div class="chat-list">
    ...
    <!-- 🔍 SEARCH -->
        <form method="post" action="/LapTrinhWeb/baitaplon/Chat/search">
            ...
            <?php if (!empty($conversations)): ?>
                <?php foreach ($conversations as $c): ?>
                    ...
                    <div class="chat-user <?= ($c['id_conversation'] == ($active_conversation_id ?? 0)) ? 'active' : '' ?>"
                        onclick="window.location.href='/LapTrinhWeb/baitaplon/Chat/start/<?= $c['id_conversation'] ?>'" >
    ...
    <div class="chat-main">                
        ...
        <!-- ✅ FORM CHỈ NẰM Ở INPUT -->
            <form class="chat-input"
                method="post"
                action="/LapTrinhWeb/baitaplon/Chat/send"
                id="chatForm">
...
<script src="/LapTrinhWeb/baitaplon/public/js/openConversation.js"></script>
<script src="/LapTrinhWeb/baitaplon/public/js/OpenSearchMessage.js"></script>
<script src="/LapTrinhWeb/baitaplon/public/js/openDialogVote.js"></script>
