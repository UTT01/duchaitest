...
$mainAvatar = !empty($p['avatar']) ? "/LapTrinhWeb/baitaplon/" . $p['avatar'] : 'https://via.placeholder.com/150';
// Lưu ý: Đường dẫn ảnh giữ nguyên /baitaplon/ nếu thư mục project của bạn tên là baitaplon
$mainImg = !empty($p['anh_dai_dien']) ? "/LapTrinhWeb/baitaplon/" . $p['anh_dai_dien'] : 'https://via.placeholder.com/500';
?>
...
<div class="container mt-5 mb-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="/LapTrinhWeb/baitaplon/Home">Trang chủ</a>
            </li>
            <li class="breadcrumb-item">
                <a href="/LapTrinhWeb/baitaplon/Home?danhmuc=<?php echo $p['id_danhmuc']; ?>">
            ...
            <div class="card border-0">
                ...
                <div class="d-flex overflow-auto gap-2">
                    ...
                    <?php foreach ($imgs as $img): ?>
                       <img src="/LapTrinhWeb/baitaplon/<?php echo htmlspecialchars($img['url_anh']); ?>"
    ...
    <?php
        ...
        $profileLink = "/LapTrinhWeb/baitaplon/User/Profile/" . urlencode($sellerId);
        ...
        <a href="<?php echo htmlspecialchars($profileLink); ?>" class="text-decoration-none text-dark hover-name">
            <?php echo htmlspecialchars($p['hoten']); ?>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="/LapTrinhWeb/baitaplon/Chat/start/<?php echo $p['id_user']; ?>?product_id=<?php echo $p['id_sanpham']; ?>"
