        ...
        <?php foreach ($products as $p): ?>
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card h-100 product-card">
                    ...
                    ?>
                    <img src="/LapTrinhWeb/baitaplon/<?php echo htmlspecialchars($img); ?>" class="card-img-top" alt="Ảnh sản phẩm" style="width:100%;height:180px;object-fit:cover;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <?php
                            ...
                            // 2. Tạo link cơ bản
                            $detailLink = "/LapTrinhWeb/baitaplon/Home/detail_Sanpham/" . $p['id_sanpham'];
