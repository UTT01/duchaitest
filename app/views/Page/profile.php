...
$avatar = (!empty($u['avatar'])) ? "/LapTrinhWeb/baitaplon/" . $u['avatar'] : "https://via.placeholder.com/150";
                    ...
                    <?php foreach ($products as $p): ?>
                        <div class="col-sm-6 col-lg-4">
                            <div class="card h-100 product-card shadow-sm">
                                <?php
                                $img = isset($p['anh_hienthi']) ? "/LapTrinhWeb/baitaplon/" . $p['anh_hienthi'] : 'https://via.placeholder.com/300';
