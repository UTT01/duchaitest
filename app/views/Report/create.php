...
<head>
    ...
    <link rel="stylesheet" href="/LapTrinhWeb/baitaplon/public/css/ReportForm.css">
...
<div class="report-wrapper">
    <div class="report-card">
        ...
        <form action="/LapTrinhWeb/baitaplon/Report/submit" method="POST" enctype="multipart/form-data" class="report-form">
